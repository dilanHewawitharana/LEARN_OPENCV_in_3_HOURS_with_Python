...
cv2.createTrackbar('Hue Min', 'TrackBars', 20, 179, val_changed)
cv2.createTrackbar('Hue Max', 'TrackBars', 86, 179, val_changed)
cv2.createTrackbar('Sat Min', 'TrackBars', 17, 255, val_changed)
cv2.createTrackbar('Sat Max', 'TrackBars', 255, 255, val_changed)
cv2.createTrackbar('Val Min', 'TrackBars', 202, 255, val_changed)
cv2.createTrackbar('Val Max', 'TrackBars', 255, 255, val_changed)

img = cv2.imread('Resources/car02.jpeg')
